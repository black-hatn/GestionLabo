...
def create_exam(
    ...
    AuditLog.log_action(
        db, current_user.id, "CREATE_EXAM", "exam", exam.id, details={"name": exam.name}
    )
    return exam
...
DEFAULT_EXAMS = [
    # Hématologie
    {
        ...
        "unit": "cells/µL",
        "description": "Analyse complète des éléments figurés du sang",
    },
    {"name": "Hémoglobine", "unit": "g/dL", "description": "Taux d'hémoglobine"},
    {
        "name": "Hématocrite",
        "unit": "%",
        "description": "Proportion de globules rouges",
    },
    {
    ...
    },
    {
        ...
        "unit": "",
        "description": "Détermination du groupe sanguin",
    },
    {
        "name": "TP / TCA (Bilan de Coagulation)",
        "unit": "%/s",
        "description": "Exploration de la coagulation",
    },
    # Biochimie
    ...
    {"name": "Acide Urique", "unit": "µmol/L", "description": "Taux d'acide urique"},
    {
        ...
        "unit": "U/L",
        "description": "Enzyme hépatique — cytolyse",
    },
    {
    ...
    },
    {
        ...
        "unit": "µmol/L",
        "description": "Marqueur hépatique",
    },
    {
        "name": "Protéines Totales",
        "unit": "g/L",
        "description": "Taux de protéines sanguines",
    },
    {
        "name": "Albumine",
        "unit": "g/L",
        "description": "Protéine plasmatique principale",
    },
    ...
    {"name": "Calcium Sérique", "unit": "mmol/L", "description": "Taux de calcium"},
    {
        "name": "Fer Sérique",
        "unit": "µmol/L",
        "description": "Taux de fer — bilan martial",
    },
    {
    ...
    {
        "name": "Sérologie VIH (HIV Test)",
        "unit": "",
        "description": "Dépistage du VIH 1 & 2",
    },
    {
        "name": "Sérologie Hépatite B (AgHBs)",
        "unit": "",
        "description": "Dépistage hépatite B",
    },
    {"name": "Sérologie Hépatite C", "unit": "", "description": "Dépistage hépatite C"},
    {
        "name": "TPHA / VDRL (Syphilis)",
        "unit": "",
        "description": "Dépistage de la syphilis",
    },
    {
        "name": "Test de Grossesse (β-HCG)",
        "unit": "mUI/mL",
        "description": "Détection de la grossesse",
    },
    # Parasitologie / Microbiologie
    {
        "name": "Goutte Épaisse — Paludisme",
        "unit": "",
        "description": "Recherche de Plasmodium sp.",
    },
    {
        "name": "ECBU (Cytobactériologie Urinaire)",
        "unit": "",
        "description": "Analyse bactériologique des urines",
    },
    {
        "name": "Coproculture",
        "unit": "",
        "description": "Analyse bactériologique des selles",
    },
    {
    ...
    {
        "name": "Bandelette Urinaire (BU)",
        "unit": "",
        "description": "Analyse urinaire rapide multi-paramètres",
    },
    # Endocrinologie
    {
        "name": "TSH (Thyréostimuline)",
        "unit": "µUI/mL",
        "description": "Exploration de la fonction thyroïdienne",
    },
    {
        "name": "PSA (Antigène Prostatique Spécifique)",
        "unit": "ng/mL",
        "description": "Marqueur du cancer de la prostate",
    },
    # Sérologie infectieuse (33ème examen)
    {
        "name": "Sérodiagnostic de Widal-Félix",
        "unit": "",
        "description": "Diagnostic sérologique de la fièvre typhoïde",
    },
]
...
def seed_default_exams(
    ...
    for item in DEFAULT_EXAMS:
        exists = db.scalar(
            select(func.count()).select_from(Exam).where(Exam.name == item["name"])
        )
        if not exists:
            db.add(
                Exam(
    ...
    db.commit()
    AuditLog.log_action(
        db, current_user.id, "SEED_EXAMS", "exam", "", details={"inserted": inserted}
    )
